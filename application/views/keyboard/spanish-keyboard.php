...
<html lang="en">
<head>
    <title>Spanish Keyboard - Teclado en Español</title>
    <meta name="description" content="">
    <meta name="keywords" content="spanish keyboard, spanish accents, spanish accents copy and paste, spanish type it, spanish symbols">
...
<section class="main-keyboard-template">
          <div class="container">
                <div class="main-keyboard-title">
                  <h1>Spanish Keyboard - Teclado en Español</h1>
                  <p>Spanish Keyboard - Teclado en Español Description</p>
                </div>  
                    ...
                    <div class="main-keyboard-box">
                      ...
                      <div class="keyboard-setting">
                        ...
                        <div class="ukrainian-keyboard">
                            <div class="row">
                                <div class="key" data-key="`"><small>`</small><p>º</p></div>
                            ...
                            <div class="row">
                                ...
                                <div class="key" data-key=";"><small>;</small><p>ñ</p></div>
                                <div class="key" data-key="'"><small>'</small><p>´</p></div>
    ...
    <div class="container">
      <div id="about">
          <div class="about-paragraph">
            <h2>Spanish Keyboard - Teclado en Español</h2>
...
?>
<script type="text/javascript" src="<?=base_url('assets/keyboard_js/spanish-keyboard.js')?>"></script>
